...
import coil.load
import com.example.myapplication.combat.Combattant
import com.example.myapplication.combat.MoteurCombat
import com.example.myapplication.combat.Statut
import com.example.myapplication.data.PokedexRepository
import com.example.myapplication.online.Reseau
...
class OnlineCombatActivity : AppCompatActivity() {
    ...
    private fun resoudre(att: Combattant, def: Combattant, atk: com.example.myapplication.combat.Attaque, attaquantEstMoi: Boolean) {
