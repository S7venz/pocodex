...
**📲 Installer :** télécharge la dernière [**Release**](https://github.com/S7venz/pocodex/releases/latest) (fichier [`PoCodex.apk`](https://github.com/S7venz/pocodex/releases/latest/download/PoCodex.apk), ~23 Mo), ouvre-le sur ton téléphone Android et autorise l'installation depuis « sources inconnues ».
